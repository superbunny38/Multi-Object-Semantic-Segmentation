...
| PSPNet pretrained on cutmix (25) (epoch: 25) + minimized HD losss + trainable weights on loss | Histogram equalizer | mean dice: 0.9555 (eft lung 0.9645 right lung: 0.9464 ) |
